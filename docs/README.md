# FinLedger Pro Documentation / 文档导航

All major reader-facing documents are available in English and Simplified Chinese. English is the canonical technical wording if the two editions temporarily differ. Meaningful changes should update both editions in the same commit.

所有主要文档均提供英文和简体中文版本。如果两个版本暂时存在差异，以英文技术表述为准；涉及含义的修改应在同一个提交中同步更新两个版本。
...
The MIT licence is kept in its original legal English text. A translation, if added later, must be clearly marked unofficial.

MIT 许可证保留原始英文法律文本。未来如果提供翻译，必须明确标注为非官方译文。
